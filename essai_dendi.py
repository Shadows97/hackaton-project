...
df = pd.read_csv("dendi_to_english_tested.csv")  # Remplacez "votre_fichier.csv" par le chemin de votre fichier CSV
...
def generate_image(texte_entree):
    ...
    correspondance = df[df['input_text'].str.contains(texte_entree)]['new_anglais'].values
